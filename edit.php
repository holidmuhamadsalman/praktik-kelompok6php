...
<body>
    ...
    ?>
        <form action="proses_edit.php?id_barang=<?php echo $id; ?>" method="post">
        <table class="table">
                <tr>
                        <td>Nama</td>
                ...
                <tr>
                        <td>Harga</td>
                        <td><input type="number" name="harga" id="" value="<?php echo $harga; ?>"></td>
                </tr>
                <tr>
                        <td>Stok</td>
                        <td><input type="text" name="stok" id="" value="<?php echo $stok; ?>"></td>
                </tr>
                <tr>
